...
?>
  <tr>
    ...
    <td><div align="center"><a href="edit.php?id=<?php echo $data['ID'] ?>" class="btn btn-warning">Edit</a>
    <a href="delete.php?id=<?php echo $data['ID'] ?>" class="btn btn-danger">Del</a></td>
